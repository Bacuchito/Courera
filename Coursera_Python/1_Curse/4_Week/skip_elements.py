...
def skip_elementos(elements):
	# code goes here
	result = []
	for objects, element in enumerate(elements):
		if objects % 2 == 0:
			result.append(element)
	return result

print(skip_elementos(["a", "b", "c", "d", "e", "f", "g"])) # Should be ['a', 'c', 'e', 'g']
print(skip_elementos(['Orange', 'Pineapple', 'Strawberry', 'Kiwi', 'Peach'])) # Should be ['Orange', 'Strawberry', 'Peach']